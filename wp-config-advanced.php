<?php
/**
 * HAXCHIPPER FILE MANAGER - PROTECTED
**/

// --- BAGIAN PENGUNCI START ---
$password = "Crypth0nX"; // Silakan ganti password di sini
